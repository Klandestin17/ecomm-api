...
class AddItemTocart(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response(
                {"message": "Item added to the cart"}, status=status.HTTP_200_OK
            )
            ...
            return Response(
                {"message": "Item add successfully"}, status=status.HTTP_201_CREATED
            )
...
class UpdateCartItemQuantity(APIView):
    ...
    def get(self, request):
        ...
        return Response(
            {"message": "Item quantity updated seccussfully"}, status=status.HTTP_200_OK
        )
